...
{
    ALIGNED_UINT8(S2N_KYBER_512_R3_ETA1 * S2N_KYBER_512_R3_N / 4 + 32)
    buf;  // +32 bytes as required by poly_cbd_eta1_avx2
...
void poly_getnoise_eta2_avx2(poly *r, const uint8_t seed[S2N_KYBER_512_R3_SYMBYTES], uint8_t nonce)
{
    ...
    #define NOISE_NBLOCKS                                                                      \
        ((S2N_KYBER_512_R3_ETA1 * S2N_KYBER_512_R3_N / 4 + S2N_KYBER_512_R3_SHAKE256_RATE - 1) \
            / S2N_KYBER_512_R3_SHAKE256_RATE)
void poly_getnoise_eta1_4x(poly *r0, poly *r1, poly *r2, poly *r3, const uint8_t seed[32], uint8_t nonce0,
...
void poly_getnoise_eta1122_4x(poly *r0, poly *r1, poly *r2, poly *r3, const uint8_t seed[32], uint8_t nonce0,
    uint8_t nonce1, uint8_t nonce2, uint8_t nonce3)
{
    ALIGNED_UINT8(NOISE_NBLOCKS * S2N_KYBER_512_R3_SHAKE256_RATE) buf[4];
    __m256i f;
