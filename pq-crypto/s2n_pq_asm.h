...
#define S2N_ANY_NONPORTABLE_OPTIMIZATIONS_ENABLED (__AVX__ || __AVX2__ || __BMI2__)
    ...
    #define S2N_ENSURE_PORTABLE_OPTIMIZATIONS \
        #error                                \
            "Compiling portable code with non-portable assembly optimizations. This can result in runtime crashes if artifacts are deployed to older CPU's without these CPU instructions"
#else
    #define S2N_ENSURE_PORTABLE_OPTIMIZATIONS
#endif
