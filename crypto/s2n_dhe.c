...
static int s2n_set_p_g_Ys_dh_params(
    struct s2n_dh_params *dh_params, struct s2n_blob *p, struct s2n_blob *g, struct s2n_blob *Ys)
{
...
int s2n_dh_p_g_Ys_to_dh_params(
...
int s2n_dh_compute_shared_secret_as_server(
