...
int main()
{
    ...
    /* Test parse with insufficient data to match extension list size */
    {
        ...
        EXPECT_FAILURE_WITH_ERRNO(s2n_extension_list_parse(&stuffer, &parsed_extension_list), S2N_ERR_BAD_MESSAGE);
    ...
    /* Test error on duplicate extensions */
    {
        ...
        EXPECT_FAILURE_WITH_ERRNO(
            s2n_extension_list_parse(&stuffer, &parsed_extension_list), S2N_ERR_DUPLICATE_EXTENSION);
        EXPECT_RAW_EQUAL(parsed_extension_list, stuffer);
    ...
    /* Test parse multiple extensions */
    {
        ...
        EXPECT_PARSED_EXTENSION_EQUAL(
            parsed_extension_list, test_extension_3.iana_value, other_test_data, sizeof(other_test_data));
        EXPECT_RAW_EQUAL(parsed_extension_list, stuffer);
    ...
    /* Test parsed extensions assigned correct indexes */
    {
        ...
        uint16_t expected_order[] = { test_extension.iana_value, test_extension_2.iana_value,
            test_extension_3.iana_value };
