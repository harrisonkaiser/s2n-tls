...
int main(int argc, char **argv)
{
    ...
    if (conn->secure->cipher_suite->record_alg->cipher->is_available()) {
        ...
        EXPECT_SUCCESS(
            conn->secure->cipher_suite->record_alg->cipher->set_decryption_key(&conn->secure->client_key, &key_iv));
        EXPECT_SUCCESS(
            conn->secure->cipher_suite->record_alg->cipher->set_encryption_key(&conn->secure->server_key, &key_iv));
        ...
        EXPECT_FAILURE_WITH_ERRNO(
            conn->secure->cipher_suite->record_alg->cipher->init(&conn->secure->server_key), S2N_ERR_UNIMPLEMENTED);
        EXPECT_FAILURE_WITH_ERRNO(
            conn->secure->cipher_suite->record_alg->cipher->init(&conn->secure->client_key), S2N_ERR_UNIMPLEMENTED);
        EXPECT_FAILURE_WITH_ERRNO(
            conn->secure->cipher_suite->record_alg->cipher->set_decryption_key(&conn->secure->client_key, &key_iv),
