...
int main(int argc, char **argv)
{
    ...
    uint8_t longsekrit[] =
        "This is a really really really long key on purpose to make sure that it's longer than the block size";
    ...
    EXPECT_EQUAL(
        memcmp(output_pad,
            "8552563cadd583b79dcc7225bb79bc6483c63f259187162e1c9d4283eb6299ef1bc3ca81c0c40fc7b22f7a1f3b93adb4", 48 * 2),
        0);
    ...
    /* Reference value from python */
    EXPECT_EQUAL(memcmp(output_pad,
                     "0a834a1ed265042e2897405edb4fdd9818950cd5bea10b828f2fed45a1cb6dbd2107e4b04eb20f211998cd4e8c7e11ebd"
                     "cb0103ac63882481e1bb8083d07f4be",
                     64 * 2),
        0);
