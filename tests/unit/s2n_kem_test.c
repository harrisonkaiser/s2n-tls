...
int main(int argc, char **argv)
{
...

    {
        ...
        EXPECT_FAILURE_WITH_ERRNO(
            s2n_cipher_suite_to_kem(classic_ecdhe_iana, &compatible_params), S2N_ERR_KEM_UNSUPPORTED_PARAMS);
    ...
    }
    {
        ...
        kem_extension_size kem_extensions[] = { TLS_PQ_KEM_EXTENSION_ID_KYBER_512_R3 };

        const struct s2n_kem *kems[] = { &s2n_kyber_512_r3 };
    ...
    }
    {
        ...
        EXPECT_FAILURE_WITH_ERRNO(
            s2n_get_kem_from_extension_id(non_existent_kem_id, &returned_kem), S2N_ERR_KEM_UNSUPPORTED_PARAMS);
    }
