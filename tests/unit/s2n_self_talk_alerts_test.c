...
int main(int argc, char **argv)
{
    ...
    /* Test that we ignore Warning Alerts in S2N_ALERT_IGNORE_WARNINGS mode in TLS1.2 */
    {
        ...
        struct alert_ctx warning_alert = { .write_fd = io_pair.server,
            .invoked = 0,
            .count = 2,
            .level = TLS_ALERT_LEVEL_WARNING,
            .code = TLS_ALERT_UNRECOGNIZED_NAME };
    ...
    /* Test that we don't ignore Fatal Alerts in S2N_ALERT_IGNORE_WARNINGS mode in TLS1.2 */
    {
        ...
        /* Set up the callback to send an alert after receiving ClientHello */
        struct alert_ctx fatal_alert = { .write_fd = io_pair.server,
            .invoked = 0,
            .count = 1,
            .level = TLS_ALERT_LEVEL_FATAL,
            .code = TLS_ALERT_UNRECOGNIZED_NAME };
