    ...
    const struct s2n_ecc_named_curve *expected_curve, bool hrr_expected)
{
    ...
    if (expected_kem_group) {
        ...
        POSIX_ENSURE_EQ(
            expected_kem_group->curve, server_conn->kex_params.server_kem_group_params.ecc_params.negotiated_curve);
    ...
    if (expected_kem_group) {
        ...
        POSIX_ENSURE_EQ(
            expected_kem_group->curve, client_conn->kex_params.server_kem_group_params.ecc_params.negotiated_curve);
