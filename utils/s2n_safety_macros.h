 ...
 */
#define RESULT_CHECKED_MEMCPY(destination, source, len) \
    __S2N_ENSURE_SAFE_MEMCPY((destination), (source), (len), RESULT_GUARD_PTR)
 ...
 *   `len` bytes.
 */
#define RESULT_CHECKED_MEMSET(destination, value, len) \
    __S2N_ENSURE_SAFE_MEMSET((destination), (value), (len), RESULT_ENSURE_REF)
 ...
 *   shall be at least `len` bytes.
 */
#define POSIX_CHECKED_MEMCPY(destination, source, len) \
    __S2N_ENSURE_SAFE_MEMCPY((destination), (source), (len), POSIX_GUARD_PTR)
 ...
 *   `len` bytes.
 */
#define POSIX_CHECKED_MEMSET(destination, value, len) \
    __S2N_ENSURE_SAFE_MEMSET((destination), (value), (len), POSIX_ENSURE_REF)
 ...
 *   `len` bytes.
 */
#define PTR_CHECKED_MEMSET(destination, value, len) \
    __S2N_ENSURE_SAFE_MEMSET((destination), (value), (len), PTR_ENSURE_REF)
